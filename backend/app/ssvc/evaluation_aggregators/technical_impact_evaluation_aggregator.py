...
from app.ssvc.evaluation_units.technical_impact.base_technical_impact_evaluation_unit import BaseTechnicalImpactEvaluationUnit
from app.ssvc.evaluation_units.technical_impact.gemini_technical_impact_evaluation_unit import \
    GeminiTechnicalImpactEvaluationUnit
from app.ssvc.evaluation_units.technical_impact.openai_technical_impact_evaluation_unit import \
    OpenaiTechnicalImpactEvaluationUnit
from app.ssvc.evaluation_units.technical_impact.vulnrichment_technical_impact_evaluation_unit import \
